Changes:
- replaced model.py with feature vector extraction functions (from: https://gist.github.com/kielnino/3965d905a921abbe29a7c89af5ba1114)
- replaced visualize.py (from: https://github.com/deontaljaard/mrcnn-docker)
- replaced images and added detection result files
- maskrcnn_feature_vector_extraction.ipynb

Tested in docker environment:
https://github.com/deontaljaard/mrcnn-docker (without COCO files)
